...
return [
    ...
    */
    ...
    | sobre recursos obsoletos do PHP e da biblioteca. Isso permite que você prepare
    | sua aplicação para futuras versões principais das dependências.
    |
    */
    ...
    | o Laravel usa a biblioteca de log Monolog PHP. Isso fornece
    | uma variedade de manipuladores/formatares de log poderosos para utilizar.
    |
